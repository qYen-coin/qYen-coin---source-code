...
This document provides guidelines for internationalization of the qYen Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `qyen_en.ts` remains unchanged.
