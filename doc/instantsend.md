...
This mechanism has been integrated into Bitcore-Node-qYen which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/qyenpay/insight-api-qyen#web-socket-api](https://github.com/qyenpay/insight-api-qyen#web-socket-api)
* API: [https://github.com/qyenpay/insight-api-qyen#instantsend-transactions](https://github.com/qyenpay/insight-api-qyen#instantsend-transactions)
