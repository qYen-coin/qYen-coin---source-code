...
* qyen.conf: contains configuration settings for qyend or qyen-qt
* qyend.pid: stores the process id of qyend while running
...
* debug.log: contains debug information and general logging generated by qyend or qyen-qt
