...
/** Utility functions used by the qYen Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "qyen:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load qyen specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a qyen specific theme is activated (light/dark).*/
