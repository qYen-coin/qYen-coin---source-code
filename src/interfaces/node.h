...
//! Interface for the src/evo part of a qyen node (qyend process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/llmq part of a qyen node (qyend process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a qyen node (qyend process).
...
//! Top-level interface for a qyen node (qyend process).
class Node
{
public:
    virtual ~Node() {}
