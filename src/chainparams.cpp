 ...
 * database.
 *
 * CBlock(hash=00000ffd590b14, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=e0028e, nTime=1656958462, nBits=1e0ffff0, nNonce=790989, vtx=1)
...
{
    const char* pszTimestamp = "The Golden Flower";
    const CScript genesisOutputScript = CScript() << ParseHex("04b71f7c2c7c2ed06337ab362d29ba5f71646ef0cf9ad07b0f99d89372352004afbb1af05719da2cf85d3499e59267712230f0966a28996ae5c4b94a574c0cc2e4") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.nMasternodeMinimumConfirmations = 9;
        ...
        consensus.nPowTargetTimespan = 18 * 60;
        ...
        consensus.defaultAssumeValid = uint256S("0x00000191ae539ec2a0d84ab9a9508dc5b5641b2da39d9144fbede816034ac6dd"); 
        ...
        genesis = CreateGenesisBlock(1656958462, 790989, 0x1e0ffff0, 1, 5 * COIN);
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x00000191ae539ec2a0d84ab9a9508dc5b5641b2da39d9144fbede816034ac6dd"));
        assert(genesis.hashMerkleRoot == uint256S("0xa60c951b8a3329d62af6a87efc07c7e153c79954a1b6c441f801c5a6f553596f"));
        ...
        vSeeds.emplace_back("DII-NVCSVO5U");
        ...
        // qYen BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x88, 0xB2, 0x1E};
        // qYen BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x88, 0xAD, 0xE4};

        // qYen BIP44 coin type is '5'
        nExtCoinType = 5;
        ...
        vSporkAddresses = {"QctiuQVYuX718mkodYas1uAw18CFpE8A4Q"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;

        checkpointData = {
            {
                {0, uint256S("0x00000191ae539ec2a0d84ab9a9508dc5b5641b2da39d9144fbede816034ac6dd")},
            }
        };

        chainTxData = ChainTxData{
            1656958462, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x0000067765073548e5dfd4bfabc1c653afcb24b80b9c1dbb7edd7cf63b8222c5"); 
        ...
        genesis = CreateGenesisBlock(1656958467UL, 2841435UL, 0x1e0ffff0, 1, 5 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x0000067765073548e5dfd4bfabc1c653afcb24b80b9c1dbb7edd7cf63b8222c5"));
        assert(genesis.hashMerkleRoot == uint256S("0xa60c951b8a3329d62af6a87efc07c7e153c79954a1b6c441f801c5a6f553596f"));
        ...
        // Testnet qYen BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Testnet qYen BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Testnet qYen BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
        ...
        vSporkAddresses = {"Yk6VahoHNGaHKSfsudJESR8Yd6iumsfLBC"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;

        checkpointData = {
            {
                {0, uint256S("0x0000067765073548e5dfd4bfabc1c653afcb24b80b9c1dbb7edd7cf63b8222c5")},
            }
        };

        chainTxData = ChainTxData{
            1656958467, // * UNIX timestamp of last known number of transactions
            0,    // * total number of transactions between genesis and that timestamp
                        //   (the tx=... number in the SetBestChain debug.log lines)
            0        // * estimated number of transactions per second after that timestamp
        };
...
public:
    CDevNetParams(bool fHelpOnly = false) {
        ...
        genesis = CreateGenesisBlock(1656958472, 0, 0x207fffff, 1, 5 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x3b5353221699d9e28522723cc2f874aa49a765fc80c2f2efcc2ea2ca9356250f"));
        assert(genesis.hashMerkleRoot == uint256S("0xa60c951b8a3329d62af6a87efc07c7e153c79954a1b6c441f801c5a6f553596f"));

        if (!fHelpOnly) {
            devnetGenesis = FindDevNetGenesisBlock(genesis, 5 * COIN);
        ...
        checkpointData = (CCheckpointData) {
            {
                { 0, uint256S("0x3b5353221699d9e28522723cc2f874aa49a765fc80c2f2efcc2ea2ca9356250f")},
...
public:
    CRegTestParams() {
        ...
        // privKey: 7vaybqBoTz9bb5pxLpYPwzDqMxHXi5NyWX2qFfwmrz3hXTDmUgh
        vSporkAddresses = {"YZQzZtV5MK8bz5EQkDfoyvd1iDVxpYjFhC"};
        nMinSporkKeys = 1;
        ...
        // Regtest qYen addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,78);
        // Regtest qYen script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,79);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,206);
        // Regtest qYen BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Regtest qYen BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Regtest qYen BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
