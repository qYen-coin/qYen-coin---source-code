Contributing to qYen Core
============================

The qYen Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/qyenpay/qyen/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the qYen Core project (and related
projects such as libsecp256k1), and is not to be confused with overall qYen
Network Protocol consensus changes.

Whether a pull request is merged into qYen Core rests with the project merge
...
Patches that change qYen consensus rules are considerably more involved than
...
Where a patch set proposes to change the qYen consensus, it must have been
...
The review process is normally fairly responsive on the qYen Core repository, however
...
The project leader is the release manager for each qYen Core release.
