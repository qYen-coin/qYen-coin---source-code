...
Arguments:
    <base_directory> - The base directory of a qYen Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The qYen Core developers'
...
Arguments:
    <base_directory> - The base directory of qYen Core source code repository.
"""
...
Arguments:
    <file> - A source file in the qYen Core repository.
"""
