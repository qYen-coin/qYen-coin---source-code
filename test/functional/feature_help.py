...
"""Verify that starting qyend with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start qyend with -h for help text")
        ...
        self.log.info("Start qyend with -version for version information")
